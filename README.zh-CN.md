...
> **Token 基准：Lean 215，上游 `@juicesharp/rpiv-ask-user-question@2.10.1` 1,258，减少 82.9%。**
...
| 上游 `@juicesharp/rpiv-ask-user-question@2.10.1` | `ask_user_question` (1,258) | **1,258** |

节省 **1,043 tokens（82.9%）**。
